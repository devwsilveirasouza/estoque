...
@section('content')
    ...
    <div class="card-body">
        ...
        <form id="form_cadProd" class="form_cadProd" action="{{ route('product-store'); }}" method="post">
            @csrf
            <div class="form-group">
                <label for="exampleInputText">SKU</label>
                <input type="text" class="form-control" id="exampleInputText" name="sku" aria-describedby="textlHelp" placeholder="SKU...">
              </div>
            <div class="form-group">
